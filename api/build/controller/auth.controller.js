...
exports.signup = exports.signin = exports.getMe = void 0;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 6:
            ...
            newUser = (0, _context.t0)(_context.t4);
            _context.next = 11;
            return newUser.save();
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            ...
            decoded = _jsonwebtoken["default"].decode(authorizationHeader[1], _config["default"].SECRET);
            _context3.next = 4;
